...
- Descriptive alt text for meaningful images; empty `alt=""` for decorative graphics. Reserve any humor for adjacent visible captions, never inside the alt attribute.
