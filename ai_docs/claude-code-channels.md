...
> **Note:** Channels are in [research preview](#research-preview) and require Claude Code v2.1.80 or later. They require claude.ai login. Console and API key authentication is not supported. Team and Enterprise organizations must [explicitly enable them](#enterprise-controls).
...
> **Tip:** You can pass several plugins to `--channels`, space-separated.
