...
//
// PORTED VERBATIM from apps/server/src/pricing.ts. Pure (no DB) — the cost
// math and the date-suffix boundary matcher are non-obvious and covered by
// pricing.test.ts; preserve exactly.
