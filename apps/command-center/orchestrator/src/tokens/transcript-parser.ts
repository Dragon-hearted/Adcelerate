// PORTED VERBATIM from apps/server/src/transcript-parser.ts. The ephemeral
// cache-field PRESENCE detection and the refuse-to-invent-a-timestamp guard
// are subtle and covered by transcript-parser.test.ts; preserve exactly.

import { computeCost } from './pricing';
import type { TokenEventRow } from './store';
