// Unit tests for `parseLine` from tokens/transcript-parser.ts. PORTED VERBATIM
// from apps/server/src/transcript-parser.test.ts (only the import path changed)
// — asserts parity with the legacy parser.
//
...
import { parseLine } from '../../src/tokens/transcript-parser';
