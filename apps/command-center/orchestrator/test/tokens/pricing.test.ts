...
// in tokens/pricing.ts. PORTED VERBATIM from apps/server/src/pricing.test.ts
// (only the import path changed) — asserts parity with the legacy costing.
//
...
import { computeCost, PRICING } from '../../src/tokens/pricing';
